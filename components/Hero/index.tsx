...
export function HeroComp(props: { data: { data: { attributes: { title: any; headline: any; txtButton: any; imageHero: any; }; }[]; }; }) {
      ...
      <Overlay
        ...
        />
              <Container className={classes.container}>
                ...
                <Text className={classes.description} size="xl" mt="xl">{headline}</Text>
                <Button onClick={clickBtn} variant="gradient" gradient={{ from: 'teal', to: 'lime', deg: 105 }} size="xl" radius="xl" className={classes.control}>
                  {txtButton}
                </Button>
              </Container>
          </div>
